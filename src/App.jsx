...
class App extends Component{
    ...
    quebraBiscoito() {
        ...
        let numeroAleatório = Math.floor(Math.random() * this.frases.length);
        state.textoFrase = '" ' + this.frases[numeroAleatório] + ' "';
        this.setState(state);
    }
    ...
    render(){
        return(
            <div className='container'>
               <img src={biscoitoImage} alt='Biscoito Image' className='img'/>
